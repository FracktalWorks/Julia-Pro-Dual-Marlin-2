...
//#define HOTEND_IDLE_TIMEOUT
  ...
  #define HOTEND_IDLE_TIMEOUT_SEC (15*60)   //(5*60) // (seconds) Time without extruder movement to trigger protection // FW
  #define HOTEND_IDLE_MIN_TRIGGER   185    //180 // (°C) Minimum temperature to enable hotend protection // FW
 ...
 */
  ...
  #define INTERPOLATE      false
    ...
    #define X_CURRENT       1500 //800        // (mA) RMS current. Multiply by 1.414 for peak current. // FW
   ...
   */
  #define CHOPPER_TIMING CHOPPER_DEFAULT_24V        //24V // All axes (override below) // FW
...
//#define MAX7219_DEBUG
  ...
  #define MAX7219_DEBUG_PLANNER_HEAD  3 //2  // Show the planner queue head position on this and the next LED matrix row // FW
  #define MAX7219_DEBUG_PLANNER_TAIL  5 //4  // Show the planner queue tail position on this and the next LED matrix row // FW
